...
pub enum TranslatedString {
    ...
    auto_lock__turned_on = 873,  // "Auto-lock turned on"
    backup__info_multi_share_backup = 874,  // "Your wallet backup contains multiple lists of words in a specific order (shares)."
    backup__info_single_share_backup = 875,  // "Your wallet backup contains {0} words in a specific order."
    backup__title_backup_completed = 876,  // "Wallet backup completed"
    backup__title_create_wallet_backup = 877,  // "Create wallet backup"
    haptic_feedback__disable = 878,  // "Disable haptic feedback?"
    haptic_feedback__enable = 879,  // "Enable haptic feedback?"
    haptic_feedback__subtitle = 880,  // "Setting"
    haptic_feedback__title = 881,  // "Haptic feedback"
    instructions__continue_holding = 882,  // "Continue\nholding"
    instructions__enter_next_share = 883,  // "Enter next share"
    instructions__hold_to_continue = 884,  // "Hold to continue"
    instructions__hold_to_exit_tutorial = 885,  // "Hold to exit tutorial"
    instructions__hold_to_finish_tutorial = 886,  // "Hold to finish tutorial"
    instructions__learn_more = 887,  // "Learn more"
    instructions__shares_continue_with_x_template = 888,  // "Continue with Share #{0}"
    instructions__shares_start_with_1 = 889,  // "Start with share #1"
    instructions__tap_to_start = 890,  // "Tap to start"
    passphrase__title_passphrase = 891,  // "Passphrase"
    recovery__dry_run_backup_not_on_this_device = 892,  // "Wallet backup not on this device"
    recovery__dry_run_invalid_backup_entered = 893,  // "Invalid wallet backup entered"
    recovery__dry_run_slip39_valid_all_shares = 894,  // "All shares are valid and belong to the backup in this device"
    recovery__dry_run_slip39_valid_share = 895,  // "Entered share is valid and belongs to the backup in the device"
    recovery__dry_run_verify_remaining_shares = 896,  // "Verify remaining recovery shares?"
    recovery__enter_each_word = 897,  // "Enter each word of your wallet backup in order."
    recovery__info_about_disconnect = 898,  // "It's safe to disconnect your Trezor while recovering your wallet and continue later."
    recovery__share_does_not_match = 899,  // "Share doesn't match"
    reset__cancel_create_wallet = 900,  // "Cancel create wallet"
    ...
    tutorial__first_transaction_finish = 912,  // "took place on 12 January 2009."
    tutorial__first_transaction_intro = 913,  // "The world's first bitcoin transaction"
    tutorial__menu = 914,  // "Menu includes context-specific actions and options."
    tutorial__one_more_step = 915,  // "One more step..."
    tutorial__ready_to_use_safe5 = 916,  // "Well done!\nNow you're ready to use your Trezor Safe 5."
    tutorial__subtitle_safe5 = 917,  // "Trezor Safe 5 tutorial"
    tutorial__swipe_up_and_down = 918,  // "Swipe up & down to move through screens."
    tutorial__title_navigation = 919,  // "Navigation"
    tutorial__welcome_safe5 = 920,  // "Welcome to Trezor Safe 5."
    words__good_to_know = 921,  // "Good to know"
